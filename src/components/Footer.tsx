          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all cursor-pointer shadow-lg hover:shadow-[#25D366]/20"
                aria-label="WhatsApp"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#229ED9] hover:text-white hover:border-[#229ED9] transition-all cursor-pointer shadow-lg hover:shadow-[#229ED9]/20"
                aria-label="Telegram"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all cursor-pointer shadow-lg hover:shadow-[#1877F2]/20"
                aria-label="Facebook"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] transition-all cursor-pointer shadow-lg hover:shadow-[#FF0000]/20"
                aria-label="YouTube"
              >
