    ...
    <section id="Contact" className="py-24 md:py-32 relative overflow-hidden bg-[#020617]">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[40px] overflow-hidden flex flex-col lg:flex-row shadow-[0_0_80px_rgba(0,0,0,0.6)]">
          ...
          <div className="flex-1 p-8 md:p-12 lg:p-16 relative overflow-hidden border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col justify-between">
            {/* Ambient Light */}
          ...
          <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col justify-center relative bg-white/[0.02]">
