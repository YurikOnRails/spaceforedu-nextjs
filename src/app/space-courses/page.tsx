...
const CoursesHero = () => (
  <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-20">
    ...
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-orange-500/20 rounded-full blur-[120px] animate-pulse"></div>
...
export default function SpaceCourses() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white selection:bg-orange-500/30 selection:text-orange-200 font-sans">
      <Navbar />
      <CoursesHero />
      <Features />
      <InfoBlocks />
