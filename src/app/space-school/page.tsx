        ...
        <RevealOnScroll>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="bg-purple-600 text-white px-10 py-5 rounded-xl font-bold text-lg hover:bg-purple-700 transition-all flex items-center justify-center gap-2 shadow-xl hover:shadow-purple-500/20 cursor-pointer"
            >
...
export default function SpaceSchool() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white selection:bg-purple-500/30 selection:text-purple-200 font-sans">
      <Navbar />
      <SchoolHero />
      <Steps />
      <SchoolTypes />
